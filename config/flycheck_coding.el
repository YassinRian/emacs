...
(use-package corfu
  ...
  (global-corfu-mode)
  ;;
  (advice-add 'corfu-insert-separator :before #'(lambda ()
                                                  (if (>= corfu--index 0)
						      (progn
							(corfu-complete)
							(insert "")))))
...
;; Enable Apheleia globally or for specific modes
...
;;(setenv "PATH" (concat (getenv "PATH") ":/path/to/your/project/node_modules/.bin"))
;;(setq exec-path (append exec-path '("/path/to/your/project/node_modules/.bin")))


;;(setq apheleia-formatters		
;;      '((prettier "./node_modules/.bin/prettier" "--stdin-filepath" filepath)))
...
(use-package yasnippet
  ...
  :init
  ;; (defun my/corfu-completion-at-point ()
  ;;   "Combine cape-yasnippet with existing completion at point functions."
  ;;   (let ((completion-at-point-functions
  ;;          (cons #'cape-yasnippet completion-at-point-functions)))
  ;;     (completion-at-point)))

  ;; (add-hook 'conf-mode-hook 'my/corfu-completion-at-point)
  ;; (add-hook 'prog-mode-hook 'my/corfu-completion-at-point)
  ;; (add-hook 'text-mode-hook 'my/corfu-completion-at-point)
  )
...
(use-package web-mode
  ...
  (add-hook 'web-mode-hook
	    (lambda ()
	      ...
	      (setq web-mode-css-indent-offset 2)    ; CSS indentation within HTML
